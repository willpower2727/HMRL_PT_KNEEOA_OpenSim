...
%This script reduces gait cycles from the knee OA study and analyzes
%kinematics
%09/27/2013
%WDA
...
%     LKNEEirot = data(:,13)*-1;%make ext rot positive
    ...
    RANKplant = data(:,14)*-1-80.238;%plantar Flexion is positive here...
    LANKplant = data(:,17)*-1-73.435;
...
for zz = 1:length(rindex)-1
    ...
    %**********************************************************************
    %normalize relative to Baseline trial
%     if z ~= 1
%         
%         Rk1{zz,z} = (Rk1{zz,z}-Rk1{zz,1})/abs(Rk1{zz,1})*100;
%         Rk2{zz,z} = (Rk2{zz,z}-Rk2{zz,1})/abs(Rk2{zz,1})*100;
%         Rk3{zz,z} = (Rk3{zz,z}-Rk3{zz,1})/abs(Rk3{zz,1})*100;
%         Rk4{zz,z} = (Rk4{zz,z}-Rk4{zz,1})/abs(Rk4{zz,1})*100;
%         Rk5{zz,z} = (Rk5{zz,z}-Rk5{zz,1})/abs(Rk5{zz,1})*100;
%         Rk6{zz,z} = (Rk6{zz,z}-Rk6{zz,1})/abs(Rk6{zz,1})*100;
%         
%         Rk7{zz,z} = (Rk7{zz,z}-Rk7{zz,1})/abs(Rk7{zz,1})*100;
%         Rk8{zz,z} = (Rk8{zz,z}-Rk8{zz,1})/abs(Rk8{zz,1})*100;
%         Rk9{zz,z} = (Rk9{zz,z}-Rk9{zz,1})/abs(Rk9{zz,1})*100;
%         
%         Rh1{zz,z} = (Rh1{zz,z}-Rh1{zz,1})/abs(Rh1{zz,1})*100;
%         Rh3{zz,z} = (Rh3{zz,z}-Rh3{zz,1})/abs(Rh3{zz,1})*100;
%         Rh5{zz,z} = (Rh5{zz,z}-Rh5{zz,1})/abs(Rh5{zz,1})*100;
%         Rh6{zz,z} = (Rh6{zz,z}-Rh6{zz,1})/abs(Rh6{zz,1})*100;
%         
%         Ra1{zz,z} = (Ra1{zz,z}-Ra1{zz,1})/abs(Ra1{zz,1})*100;
%         Ra3{zz,z} = (Ra3{zz,z}-Ra3{zz,1})/abs(Ra3{zz,1})*100;
%         Ra5{zz,z} = (Ra5{zz,z}-Ra5{zz,1})/abs(Ra5{zz,1})*100;
%         
%     else
%     end
end
...
%     if z ~= 1
%         
%         Lk1{zz,z} = (Lk1{zz,z}-Lk1{zz,1})/abs(Lk1{zz,1})*100;
%         Lk2{zz,z} = (Lk2{zz,z}-Lk2{zz,1})/abs(Lk2{zz,1})*100;
%         Lk3{zz,z} = (Lk3{zz,z}-Lk3{zz,1})/abs(Lk3{zz,1})*100;
%         try 
%         Lk4{zz,z} = (Lk4{zz,z}-Lk4{zz,1})/abs(Lk4{zz,1})*100;
%         catch me
%             [num2str(z) ' ' num2str(zz)]
%         end
%             
%         Lk5{zz,z} = (Lk5{zz,z}-Lk5{zz,1})/abs(Lk5{zz,1})*100;
%         Lk6{zz,z} = (Lk6{zz,z}-Lk6{zz,1})/abs(Lk6{zz,1})*100;
%         
%         Lk7{zz,z} = (Lk7{zz,z}-Lk7{zz,1})/abs(Lk7{zz,1})*100;
%         Lk8{zz,z} = (Lk8{zz,z}-Lk8{zz,1})/abs(Lk8{zz,1})*100;
%         Lk9{zz,z} = (Lk9{zz,z}-Lk9{zz,1})/abs(Lk9{zz,1})*100;
%         
%         Lh1{zz,z} = (Lh1{zz,z}-Lh1{zz,1})/abs(Lh1{zz,1})*100;
%         Lh3{zz,z} = (Lh3{zz,z}-Lh3{zz,1})/abs(Lh3{zz,1})*100;
%         Lh5{zz,z} = (Lh5{zz,z}-Lh5{zz,1})/abs(Lh5{zz,1})*100;
%         Lh6{zz,z} = (Lh6{zz,z}-Lh6{zz,1})/abs(Lh6{zz,1})*100;
%         
%         La1{zz,z} = (La1{zz,z}-La1{zz,1})/abs(La1{zz,1})*100;
%         La3{zz,z} = (La3{zz,z}-La3{zz,1})/abs(La3{zz,1})*100;
%         La5{zz,z} = (La5{zz,z}-La5{zz,1})/abs(La5{zz,1})*100;
%         
%     else
%     end
...
% keyboard
%write Ankle curves
curves2excelD1('OA77','F:\HMRL Pitt\Knee OA Pain Markers\Results\Curves\Ankle Dorsi Flexion Curves Day 1',MRAplant,MLAplant);
%write hip curves
curves2excelD1('OA77','F:\HMRL Pitt\Knee OA Pain Markers\Results\Curves\Hip Flexion Curves Day 1',MRHflex,MLHflex);
%write knee abd curves
curves2excelD1('OA77','F:\HMRL Pitt\Knee OA Pain Markers\Results\Curves\Knee Abduction  Curves Day 1',MRKabd,MLKabd);
%write knee flex curves
curves2excelD1('OA77','F:\HMRL Pitt\Knee OA Pain Markers\Results\Curves\Knee Flexion Curves Day 1',MRKflex,MLKflex);



%write results of key idicators to file
kneeABD2excelD1('OA77',Rk7,Rk8,Rk9,Lk7,Lk8,Lk9);
kneeFLEX2excelD1('OA77',Rk1,Rk2,Rk3,Rk4,Rk5,Rk6,Lk1,Lk2,Lk3,Lk4,Lk5,Lk6);
kneeHIP2excelD1('OA77',Rh1,Rh3,Rh5,Lh1,Lh3,Lh5);
kneeANKexcelD1('OA77',Ra1,Ra3,Ra5,La1,La3,La5);


% xlswrite([cell2mat(MRAplant)],'right ankle');
% xlswrite([cell2mat(MLAplant)],'left ankle');
% xlswrite([cell2mat(MRHflex)],'right hip');
% xlswrite([cell2mat(MLHflex)],'left hip');
% xlswrite([cell2mat(MRKflex)],'right knee flex');
% xlswrite([cell2mat(MLKflex)],'left knee flex');
% xlswrite([cell2mat(MRKabd)],'right knee abd');
% xlswrite([cell2mat(MLKabd)],'left knee abd');
