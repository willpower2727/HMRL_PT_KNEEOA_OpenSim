...
%% default preferences
DPref.ItemName  = 'objects'; % name of a special tag used to itemize cell arrays
Pref.ItemName = 'objects';%added by WDA 9/9/2014
...
if(~RootOnly && isstruct(tree))  % if struct then deal with each field separatly
