...
% setup default input files to emtpy
        ...
        %added in the 2 filenames
ModelFile = ['C:\Users\pek29\Desktop\Manpreet Gait\MS_simbody_7_16'];
MOTFile = ['MS_walk_ik_7_16.mot'];
GRFFile = [];
...
if isempty(OutputFile)
    V.InverseDynamicsTool.output_gen_force_file = [trial 'MS_id.sto'];
else V.InverseDynamicsTool.output_gen_force_file = OutputFile;
end

        %added MS_ and _7_16
        %data.Name
fileout = [data.Name 'MS_Setup_InverseDynamics_7_16.xml'];
